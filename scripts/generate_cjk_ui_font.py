...
inline const uint16_t CJK_UI_CODEPOINTS[] PROGMEM = {{
''')
        ...
        f.write('inline const uint8_t CJK_UI_GLYPH_WIDTHS[] PROGMEM = {\n')
        ...
        f.write('inline const uint8_t CJK_UI_GLYPHS[] PROGMEM = {\n')
...
def main():
    ...
    if args.output:
        ...
        output_path = project_root / 'lib' / 'EpdFont' / f'cjk_ui_font_{args.size}.h'
