# CrossPoint Reader — Japanese UI fork
...
> ### 🇯🇵 About this fork
>
> This is a community fork that adds **Japanese UI support** to [CrossPoint Reader](https://github.com/crosspoint-reader/crosspoint-reader). It is based on upstream CrossPoint Reader v1.3.x and inherits all of its features. On top of the upstream firmware it adds:
>
...
2. Download `firmware.bin` from this fork's [releases page](https://github.com/mtskf/crosspoint-reader-jp/releases).
...
This fork embeds bitmap glyphs derived from [Source Han Sans](https://github.com/adobe-fonts/source-han-sans) (© 2014–2021 Adobe), used under the [SIL Open Font License 1.1](https://scripts.sil.org/OFL). The glyphs are regenerated by `scripts/generate_cjk_ui_font.py` from the codepoint list in `lib/EpdFont/scripts/codepoints/`. All other code follows the upstream project's license (see [LICENSE](./LICENSE)).
